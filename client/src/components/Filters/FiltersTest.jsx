...
export default function Filters() {
  ...
  const renderFilterItemMobile = (item, filterType) => (
  ...
  const renderFilterItem = (item, filterType) => (
    <div key={item} className="flex items-center">
      <span
                          ...
                          <Disclosure.Panel className="pt-6">
                            <div className="space-y-6">
                              {filtersData.categories.map((category) =>
                                renderFilterItemMobile(category, "category"),
                              )}
                            </div>
                          </Disclosure.Panel>
                        </>
                    ...
                    <>
                      ...
                      <Disclosure.Panel className="pt-6">
                        <div className="space-y-4">
                          {filtersData.categories.map((category) =>
                            renderFilterItem(category, "category"),
                          )}
                        </div>
                      </Disclosure.Panel>
                    </>
                  ...
                  {({ open }) => (
                    <>
                      ...
                      <Disclosure.Panel className="pt-6">
                        <div className="space-y-4">
                          {filtersData.manufacturer.map((manufacturer) =>
                            renderFilterItem(manufacturer, "manufacturer"),
                          )}
                        </div>
                      </Disclosure.Panel>
                    </>
