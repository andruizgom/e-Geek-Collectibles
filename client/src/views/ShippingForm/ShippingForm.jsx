...
export const ShippingForm = () => {
  ...
  <div className="containerForm">
    ...
    <h2>Formulario de Envio</h2>
      ...
      <div className="form-group">
          <label>Numero de Telefono:</label>
                  <Controller
                    ...
                    render={({ field }) => <input {...field} placeholder="+54 1152193352" />}
                  />
      ...
      <button class="mt-6 w-full rounded-md bg-green-500 py-1.5 font-medium text-blue-50 hover:bg-green-600 className=" disabled={Object.keys(errors).length > 0}>
        Enviar Datos
      </button>
    </form>
  </div>
